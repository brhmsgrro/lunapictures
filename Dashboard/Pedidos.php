...
<div class="container-fluid">
  <div class="row">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
       ...
       <h3 align="center"> Listado de pedidos</h3>
        <table class="table">

          <tr>
            <th>Numero</th><th>cod cliente</th><th>Nombre</th><th>Fecha</th>
       ...
       <tr>
         <td><button class="btn-primary"  onclick="mostrarDetallePedido (<?php echo $row [0]?>)"><?php echo $row [0]?></button></td>
